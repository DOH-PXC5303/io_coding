...
library(jsonlite) # used with autocoding webservice
library(dplyr) # used throughout script
library(data.table) # used to read and write data (fread & fwrite)
library(glue) # glue::glue() used throughout script
library(furrr) # used for multi-session processing with webservice
library(future) # used for multi-session processing with webservice
